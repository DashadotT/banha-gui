...
extern int32_t get_var_co2_value();
extern void set_var_co2_value(int32_t value);
extern const char *get_var_co2_status();
extern void set_var_co2_status(const char *value);
