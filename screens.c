...
static const char *object_names[] = { "main_screen", "selection_screen", "recording_screen", "header", "obj0", "obj1", "obj2", "obj3", "temp_container", "obj4", "obj5", "temp_label", "obj6", "obj7", "obj8", "temp_status", "obj9", "obj10", "co2_container", "obj11", "obj12", "co2_label", "obj13", "obj14", "obj15", "obj16", "obj17", "obj18", "noise_container", "obj19", "obj20", "noise_label", "obj21", "obj22", "obj23", "obj24", "obj25", "obj26", "header_1", "obj27", "obj28", "obj29", "obj30", "obj31", "obj32", "obj33", "obj34", "obj35", "obj36", "obj37", "obj38", "header_2", "obj39", "obj40", "obj41", "obj42", "obj43", "record_icon", "temp_container_1", "obj44", "obj45", "temp_label_1", "obj46", "obj47", "obj48", "temp_status_1", "obj49", "obj50", "co2_container_1", "obj51", "obj52", "co2_label_1", "obj53", "obj54", "obj55", "obj56", "obj57", "obj58", "noise_container_1", "obj59", "obj60", "noise_label_1", "obj61", "obj62", "obj63", "obj64", "obj65", "obj66" };
...
static void event_handler_cb_selection_screen_obj28(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_selection_screen_obj37(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_recording_screen_obj40(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
void tick_screen_main_screen() {
    ...
    }
    {
        ...
        const char *cur_val = lv_label_get_text(objects.temp_status);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.temp_status;
            lv_label_set_text(objects.temp_status, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void create_screen_selection_screen() {
    ...
    lv_obj_set_style_bg_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0000), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 244, 13);
                    lv_obj_set_size(obj, 64, 25);
                    lv_obj_add_event_cb(obj, event_handler_cb_selection_screen_obj28, LV_EVENT_ALL, flowState);
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_selection_screen_obj37, LV_EVENT_ALL, flowState);
            lv_obj_set_style_shadow_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xebaf1c), LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0000), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_add_event_cb(obj, event_handler_cb_recording_screen_obj40, LV_EVENT_ALL, flowState);
...
void tick_screen_recording_screen() {
    ...
    }
    {
        ...
        const char *cur_val = lv_label_get_text(objects.temp_status_1);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.temp_status_1;
            lv_label_set_text(objects.temp_status_1, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
