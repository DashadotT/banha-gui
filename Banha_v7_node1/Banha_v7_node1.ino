/*
  ...
  RECORDING MODE:
  - Starts when btn_start_rec is pressed
  - Valid readings stored every 5 seconds
  - 12 readings = approximately 1 minute
  - Average sent through LoRa
  - Continues until btn_stop_rec is pressed

  STOP MODE:
  - Triggered by btn_stop_rec
  - Recording stops
  - Incomplete data is cleared
...
void startRecording() {
  ...
  // Clear old or incomplete readings
  clearStoredData();


  // Start a fresh 5-second timer
...
void clearStoredData() {
  ...
  Serial.println(
    "Clearing temporary recording RAM...");
...
void calculateAndSendAverage() {
  ...
  if (!isRecording) {
    ...
    Serial.println(
      "Not recording. Average cancelled.");
  ...
  // ===================================================
  // CHECK RECORDING AGAIN BEFORE TRANSMISSION
  // ===================================================

  if (!isRecording) {

    Serial.println(
      "Recording stopped. Transmission cancelled.");
